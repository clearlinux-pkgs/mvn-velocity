...
License  : Apache-2.0
Requires: mvn-velocity-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-velocity package.
Group: Data

%description data
data components for the mvn-velocity package.
...
%install
mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.5
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.5

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.5
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.5

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.6.2
cp %{SOURCE2} %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.6.2

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.7
cp %{SOURCE3} %{buildroot}/usr/share/java/.m2/repository/org/apache/velocity/velocity/1.7
